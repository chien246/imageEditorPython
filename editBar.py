...
class EditBar(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.new_button = Button(self, text="New",image=self.new_icon,compound=LEFT,justify=LEFT)
        self.save_button = Button(self, text="Save",image=self.save_icon,compound=LEFT)
        self.save_as_button = Button(self, text="Save As",image=self.save_icon,compound=LEFT)
        self.draw_button = Button(self, text="Draw",image=self.draw_icon,compound=LEFT)
        self.crop_button = Button(self, text="Crop",image=self.crop_icon,compound=LEFT)
        self.filter_button = Button(self, text="Filter",image=self.filter_icon,compound=LEFT)
        self.adjust_button = Button(self, text="Adjust",image=self.adjust_icon,compound=LEFT)
        self.clear_button = Button(self, text="Clear",image=self.clear_icon,compound=LEFT)
